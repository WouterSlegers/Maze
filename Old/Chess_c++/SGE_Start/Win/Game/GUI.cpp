...
void GUI::Display(){
	...
	//call algorithm, include sleep
	//print by letting it drawScene

	//tempConnected = mGFX->returnConnected();
	//newobject = mLogic->MakeMaze(object)
	//mGFX->updateConnected(newobject)
